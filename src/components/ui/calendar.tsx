  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_grid: cn('w-full border-collapse !ml-0', defaultClassNames.month_grid),
        weeks: cn('w-full !ml-0 !pl-0', defaultClassNames.weeks),
        table: 'w-full border-collapse',
        weekdays: cn('flex w-full !ml-0 !pl-0', defaultClassNames.weekdays),
        weekday: cn(
          'text-muted-foreground flex-1 select-none rounded-md text-[0.8rem] font-normal',
          defaultClassNames.weekday,
        ),
        week: cn('mt-2 flex w-full !ml-0 !pl-0', defaultClassNames.week),
        ...
        range_start: cn('bg-accent rounded-full', defaultClassNames.range_start),
