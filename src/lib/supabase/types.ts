...
//   $function$
//
// FUNCTION handle_meeting_webhook()
...
//   on_meeting_webhook: CREATE TRIGGER on_meeting_webhook AFTER INSERT OR DELETE OR UPDATE ON public.meetings FOR EACH ROW EXECUTE FUNCTION handle_meeting_webhook()
